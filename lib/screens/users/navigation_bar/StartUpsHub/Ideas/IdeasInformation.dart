...
class IdeasInformationScreen extends StatefulWidget {
  @override
  _IdeasInformationScreenState createState() => _IdeasInformationScreenState();
}

class _IdeasInformationScreenState extends State<IdeasInformationScreen> {
