                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                _updateContent("", imagePath: 'assets/images/sample_image.jpg'); // تأكد من وجود الصورة في المسار المحدد
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0), // تقليل الهوامش
                                child: Text('نموذج العمل التجاري', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            GestureDetector(
                              onTap: () {
                                _updateContent("هذا هو النص الخاص بسير المشروع.");
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0), // تقليل الهوامش
                                child: Text('سير المشروع', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            GestureDetector(
                              onTap: () {
