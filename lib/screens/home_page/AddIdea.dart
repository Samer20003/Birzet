          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                _buildLabeledTextField('عنوان الفكرة'),
                SizedBox(height: 10),
                _buildLabeledTextField('شرح مبسط عن الفكرة', maxLength: 140, maxLines: 3),
                SizedBox(height: 10),
                Text('ما هو مجال الفكرة', textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold)),
                _buildDropdownField(),
                SizedBox(height: 10),
                _buildLabeledTextField('ملخص عن الفكرة', maxLines: 5, maxLength: 2000),
                SizedBox(height: 10),
                ...
                SizedBox(height: 20),
                _buildVisibilityDropdown(), // خانة جديدة
                SizedBox(height: 20),
                Row(
