...
class _GrantpageState extends State<Grantpage> {
  List<Map<String, String>> _grants = [
    {"name": "منحة دراسية 1", "description": "وصف المنحة 1", "website": "https://example.com/apply1", "status": "مفتوحة"},
    {"name": "منحة دراسية 2", "description": "وصف المنحة 2", "website": "https://example.com/apply2", "status": "مغلقة"},
    {"name": "منحة دراسية 3", "description": "وصف المنحة 3", "website": "https://example.com/apply3", "status": "قيد التنفيذ"},
  ];
              ...
              child: Column(
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: <String>["مفتوحة", "مغلقة", "قيد التنفيذ"].map((String value) {
            ...
            child: DataTable(
              ...
              rows: grants.map((grant) {
                return DataRow(cells: [
                  ...
                  DataCell(Text(grant["status"]!, style: TextStyle(color: Colors.white))),
                  DataCell(
                    Row(
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            // منطق تعديل المنحة هنا
                          },
                        ),
                        IconButton(
                          icon: Icon(Icons.delete, color: Colors.red),
                          onPressed: () {
                            onGrantRemoved(grant);
                          },
                        ),
                      ],
                    ),
