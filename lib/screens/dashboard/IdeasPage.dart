...
class IdeasPage extends StatelessWidget {
  ...
  Widget _buildIdeasTable(BuildContext context) {
    return SingleChildScrollView(
      child: DataTable(
        columns: [
          DataColumn(label: Text('اسم الفكرة', style: TextStyle(color: Colors.white))),
          ...
          DataColumn(label: Text('تاريخ طرح الفكرة', style: TextStyle(color: Colors.white))),
        ...
        rows: [
          DataRow(cells: [
            DataCell(Text('فكرة 1', style: TextStyle(color: Colors.white))),
            ...
            DataCell(Text('مرفوضة', style: TextStyle(color: Colors.green))),
            DataCell(Row(
              children: [
                IconButton(
